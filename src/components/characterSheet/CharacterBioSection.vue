    ...
    <div class="character-bio-section">
        ...
        <div class="bio-field">
          <label>
            ...
            <input
              ...
              @input="$emit('update-character', { key: 'name', value: $event.target.value })"
        ...
        <div class="bio-field">
          <label>
            ...
            <input
              ...
              @input="$emit('update-character', { key: 'pronouns', value: $event.target.value })"
              class="bio-input-field"
            />
          </label>
        </div>
        <div class="bio-field">
          <label>
            ...
            <input
              ...
              @input="$emit('update-character', { key: 'ancestries', value: $event.target.value })"
              class="bio-input-field"
            />
          </label>
        </div>
        <div class="bio-field">
          <label>
            ...
            <input
              ...
              @input="$emit('update-character', { key: 'cultures', value: $event.target.value })"
              class="bio-input-field"
            />
          </label>
        </div>
      ...
      <label class="personality-and-background">
        ...
        <textarea
          ...
          @input="$emit('update-character', { key: 'personalityAndBackground', value: $event.target.value })"
