...
/**
 * Composable for managing equipment page layout with filtering, sorting, and pagination
 */
export function useEquipmentLayout() {
  // Stores
  ...
  return {
    ...
    // Store items for filters
    equipmentTypes: computed(() => equipmentTypesStore.items),
    equipmentSubtypes: computed(() => equipmentSubtypesStore.items),
    equipmentGrades: computed(() => equipmentGradesStore.items),
    equipmentRanges: computed(() => equipmentRangesStore.items),
    keeping: computed(() => keepingStore.keeping),
